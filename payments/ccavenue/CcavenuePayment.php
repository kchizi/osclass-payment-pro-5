    ...
    class CcavenuePayment implements iPayment
    {
        ...
        public static function button($products, $extra = null) {
            ...
            <li class="payment ccavenue-btn">
                ...
                <a id="button-confirm" class="button" onclick="$('#ccavenue_<?php echo $r; ?>').submit();">
                    <span>
                        <button class="btn btn-success btn-lg"><i class="bi bi-credit-card"></i> <?php _e('CC Avenue','payment_pro'); ?></button>
                    </span>
                </a>
            </li>
            <?php
