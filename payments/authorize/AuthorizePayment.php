...
?>
            <li class="payment authorize-btn">
                <a href="javascript:authorize_pay('<?php echo osc_format_price($amount*1000000) .',' . $description . ',' . $product_id . ','.$extra; ?>');" >
                    <button class="btn btn-success btn-lg"><i class="bi bi-credit-card"></i> <?php _e('Authorise.Net','payment_pro'); ?></button>
                </a>
            </li>
<?php
        }
