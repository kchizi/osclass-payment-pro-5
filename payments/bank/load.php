...
osc_add_route('payment-pro-admin-bank-item', 'paymentpro/admin/bank/(.+)', 'paymentpro/admin/bank/{tx}', PAYMENT_PRO_PLUGIN_FOLDER . 'payments/bank/admin/manage.php');
require_once PAYMENT_PRO_PATH . 'payments/bank/BankPayment.php';

osc_add_hook('ajax_banktransfer', array('BankPayment', 'ajaxCreate'));

if (!function_exists('payment_pro_bank_install')) {
...
if (!function_exists('payment_pro_bank_conf_save')) {
...
if (!function_exists('payment_pro_bank_conf_form')) {
...
if (!function_exists('payment_pro_bank_conf_footer')) {
 ...
 *** ADMIN SECTION ***
 *********************/
if (!function_exists('payment_pro_bank_header_tab')) {
function payment_pro_bank_header_tab($route) { ?>
    <li class="nav-item"><a class="nav-link <?php if($route == 'payment-pro-admin-bank'){ echo 'active';} ?>" href="<?php echo osc_route_admin_url('payment-pro-admin-bank'); ?>"><?php _e('Bank transfers', 'payment_pro'); ?></a></li>
<?php }
}
osc_add_hook('payment_pro_admin_header_tab', 'payment_pro_bank_header_tab');

if (!function_exists('payment_pro_bank_page_header')) {
...
if (!function_exists('payments_pro_admin_page_header_bank')) {
...
if (!function_exists('payment_pro_bank_body_class')) {
...
if (!function_exists('payment_pro_bank_title')) {
...
if (!function_exists('payments_pro_admin_title_bank')) {
function payments_pro_admin_title_bank($title) {
    return __('Bank transfers', 'payments_pro');;
}
}
osc_add_hook('init', 'payment_pro_bank_title');

osc_add_hook('payment_pro_checkout_footer', array('BankPayment', 'dialogJS'));
