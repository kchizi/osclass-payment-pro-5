...
abstract class ApiResource extends mywaypayObject
{
    private static $HEADERS_TO_PERSIST = array('mywaypay-Account' => true, 'mywaypay-Version' => true);

    public static function baseUrl()
    {
        return mywaypay::$apiBase;
    }
    ...
    public static function className()
    {
        ...
        if (substr($class, 0, strlen('mywaypay')) == 'mywaypay') {
            $class = substr($class, strlen('mywaypay'));
        }
    ...
    private static function _validateParams($params = null)
    {
        if ($params && !is_array($params)) {
            $message = "You must pass an array as the first argument to mywaypay API "
               . "method calls.  (HINT: an example call to create a charge "
               . "would be: \"mywaypay\\Charge::create(array('amount' => 100, "
    ...
    protected static function _all($params = null, $options = null)
    {
        ...
        return Util\Util::convertTomywaypayObject($response, $opts);
    }
