...
class BitcoinReceiverTest extends TestCase
{
    ...
    {
        $classUrl = BitcoinReceiver::classUrl('mywaypay_BitcoinReceiver');
    ...
    public function testCreate()
    {
        ...
        $receiver = $this->createTestBitcoinReceiver("do+fill_now@mywaypay.com");
    ...
    public function testRetrieve()
    {
        ...
        $this->assertInstanceOf('mywaypay\\BitcoinTransaction', $r->transactions->data[0]);
    }
