...
class CustomerTest extends TestCase
{
    ...
    public function testSave()
    {
        ...
        $customer->email = 'gdb@mywaypay.com';
        $customer->save();
        $this->assertSame($customer->email, 'gdb@mywaypay.com');

        $mywaypayCustomer = Customer::retrieve($customer->id);
        $this->assertSame($customer->email, $mywaypayCustomer->email);

        mywaypay::setApiKey(null);
        ...
        $this->assertSame($updatedCustomer->email, 'gdb@mywaypay.com');
    }

    /**
     * @expectedException mywaypay\Error\InvalidRequest
     */
