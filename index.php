...
function payment_pro_admin_menu() {
    osc_add_admin_menu_page('Payments Pro', osc_route_admin_url('payment-pro-admin-log'), 'plugin_payment_pro', 'administrator','bi bi-cash');
...
function payment_pro_load_styles() {
    if(!OC_ADMIN) {
        ...
        osc_enqueue_style('bootstrap-icons',osc_assets_url('bootstrap-icons/bootstrap-icons.css?v='.OSCLASS_VERSION));
...
osc_add_route('payment-pro-cart-drop', 'paymentpro/cart/drop', 'paymentpro/cart/drop', PAYMENT_PRO_PLUGIN_FOLDER . 'user/cart-drop.php');
...
osc_add_hook('item_form', 'payment_pro_form',8);
osc_add_hook('item_edit', 'payment_pro_form',8);
