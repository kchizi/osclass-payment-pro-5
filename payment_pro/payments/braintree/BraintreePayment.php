...
?>
            <li class="payment braintree-btn">
                <a href="javascript:braintree_pay('<?php echo osc_format_price($amount*1000000) .',' . $description . ',' . $product_id . ','.$extra; ?>');" >
                    <img src="'.PAYMENT_PRO_URL . 'payments/braintree/pay_with_card.png" >
                    <button class="btn btn-success btn-lg"><i class="bi bi-credit-card"></i> <?php _e('Braintree','payment_pro'); ?></button>
                </a>
            </li>';
<?php
        }
