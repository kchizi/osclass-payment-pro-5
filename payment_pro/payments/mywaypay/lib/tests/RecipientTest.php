...
class RecipientTest extends TestCase
{
    ...
    public function testSave()
    {
        ...
        $recipient->email = 'gdb@mywaypay.com';
        $recipient->save();
        $this->assertSame($recipient->email, 'gdb@mywaypay.com');

        $mywaypayRecipient = Recipient::retrieve($recipient->id);
        $this->assertSame($recipient->email, $mywaypayRecipient->email);
    }
