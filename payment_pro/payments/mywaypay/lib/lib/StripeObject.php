...
class mywaypayObject implements ArrayAccess, JsonSerializable
{
    /**
    ...
    public function &__get($k)
    {
        ...
        if (array_key_exists($k, $this->_values)) {
            ...
            $message = "mywaypay Notice: Undefined property of $class instance: $k. "
                    . "HINT: The $k attribute was set in the past, however. "
                    . "It was then wiped when refreshing the object "
                    . "with the result returned by mywaypay's API, "
            ...
            $class = get_class($this);
            error_log("mywaypay Notice: Undefined property of $class instance: $k");
            return $nullval;
        }
    }
     ...
     * @param array $opts
     *
     * @return mywaypayObject The object constructed from the given values.
     */
    ...
    public function refreshFrom($values, $opts, $partial = false)
    {
        ...
        foreach ($values as $k => $v) {
            ...
            if (self::$nestedUpdatableAttributes->includes($k) && is_array($v)) {
                ...
                $this->_values[$k] = Util\Util::convertTomywaypayObject($v, $opts);
            }
    ...
    public function serializeParameters()
    {
        ...
        foreach (self::$nestedUpdatableAttributes->toArray() as $property) {
            if (isset($this->$property)) {
                if ($this->$property instanceof mywaypayObject) {
    ...
    {
        if ($recursive) {
            return Util\Util::convertmywaypayObjectToArray($this->_values);
        } else {
            return $this->_values;
        }
    }
