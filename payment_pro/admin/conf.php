                ...
                <div class="form-horizontal">
                    ...
                    <div class="payment-pro-bg-renew">
                        ...
                        <div class="form-row renew-row <?php echo (osc_get_preference('allow_renew', 'payment_pro')!=1 ? 'hide' : ''); ?>">
                            ...
                            <div class="form-controls"><input type="text" class="xlarge" name="renew_days" value="<?php echo osc_get_preference('renew_days', 'payment_pro'); ?>" />
                            </div>
                            <span class="help-box">
                    ...
                    <div class="payment-pro-bg-wallet">
                        ...
                        <div class="form-row <?php echo ((osc_get_preference('allow_wallet', 'payment_pro')!=1 || osc_get_preference('use_tokens', 'payment_pro')!=1 )? 'hide' : ''); ?>" id="token_currency_row">
                            ...
                            <div class="form-controls"><input type="text" class="xlarge" name="token_currency" id="token_currency" value="<?php echo osc_get_preference('token_currency', 'payment_pro'); ?>" /> 
                                <span class="help-box">
                    ...
                    <div class="payment-pro-bg-misc">
                        <div class="form-row">
                            ...
                            <div class="form-controls"><input type="text" class="xlarge" name="currency" id="currency" value="<?php echo osc_get_preference('currency', 'payment_pro'); ?>" /> 
                            <span class="help-box">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-controls"><input type="text" class="xlarge" name="default_tax" value="<?php echo osc_get_preference('default_tax', 'payment_pro'); ?>" /> % (percent)
