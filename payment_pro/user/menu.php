    ...
    <?php while(osc_has_items()) {
        ...
        ?>
            <div class="item payments-item" >
                    ...
                    <?php
                    if((osc_get_preference('pay_per_post', 'payment_pro')!=1 && osc_item_is_enabled()) && osc_item_is_active()
                            || (osc_get_preference('pay_per_post', 'payment_pro')==1 && ModelPaymentPro::newInstance()->isEnabled(osc_item_id()))) {
                        if(count($options)>0) {
                        ...
                        <p class="options">
                            ...
                            if (osc_item_is_inactive() ) {
                                 _e('This listing is not active', 'payment_pro'); 
                            } else {
                                 _e('This listing is blocked', 'payment_pro'); 
                            } ?>
                            </strong>
                        </p>
                    <?php }; ?>
